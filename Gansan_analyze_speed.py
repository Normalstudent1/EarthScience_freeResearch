...
f=open('Gunsan_windspeed.csv',encoding='euc-kr')
data = csv.reader(f)
next(data)
dates = []
pressures = []
...
ax.set_title('Time Series of wind speed in Gunsan', fontsize=15)
...
df = pd.read_csv('Gunsan_windspeed.csv',encoding='euc-kr')
print(df)