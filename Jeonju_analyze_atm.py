...
f=open('Jeonju_atm.csv',encoding='euc-kr')
data = csv.reader(f)
next(data)
dates = []
pressures = []
...
ax.set_title('Time Series of Atmospheric Pressure in Jeonju', fontsize=15)
...
df = pd.read_csv('Jeonju_atm.csv',encoding='euc-kr')
print(df)
